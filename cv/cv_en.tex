...
\begin{tikzpicture}
  \clip (0,0) circle (1cm);
  \node at (0,0) {\includegraphics[width=2cm]{personal-photo.jpeg}};
\end{tikzpicture}
\end{minipage}
\hfill
\hfill
...
\subsection{\href{https://www.elixirrdigital.com/us/}{Elixirr Digital}, Zagreb, Croatia}
\begin{blank-period}{AI Engineer}{Jan 2026 - Current}
\end{blank-period}

\subsection{\href{https://unitfly.com/}{Unitfly}, Zagreb, Croatia}
\begin{period}{Software Engineer Specialist}{Jul 2020 - Jan 2026}
    ...
    \item Design and development of Document Intelligence solutions using LLMs and Azure AI services
    \item Work on multi-agent AI chatbot system for first-level customer support
